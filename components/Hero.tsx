  ...
  return (
    <section className=" py-16 flex gap-12 flex-wrap bg-gray-100 ">
      <div className="pl-8 sm:pl-12 md:pl-16 lg:pl-24 xl:w-2/5  my-auto">
        ...
        <h2 className="pb-8 w-[90%]  text-secondary-dark leading-relaxed">
        ...
        <Button
          className={cn(
            "text-white text-xl hover:text-secondary-dark rounded-none"
          )}
        >
          Learn More
        </Button>
        <Button className={cn("text-secondary- text-xl")} variant={"ghost"}>
          Contact Us
        </Button>
      </div>
